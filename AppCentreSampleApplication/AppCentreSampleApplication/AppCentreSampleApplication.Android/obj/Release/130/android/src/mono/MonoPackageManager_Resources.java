...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "AppCentreSampleApplication.Android.dll" comes first in this list. */
		"AppCentreSampleApplication.Android.dll",
		"AppCentreSampleApplication.dll",
		"FormsViewGroup.dll",
